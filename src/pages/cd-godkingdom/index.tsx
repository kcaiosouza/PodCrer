...
export default function cdgodkingdom({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD God's Kingdom Is God's Reigning | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdgodkingdom', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
