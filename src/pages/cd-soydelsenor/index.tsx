...
export default function cdsoydelsenor({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Soy del Señor | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdsoydelsenor', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
