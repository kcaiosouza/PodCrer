...
export default function cdfalandocantando61a80({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Falando e Cantando Hinos 61 a 80 | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdfalandocantando61a80', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
