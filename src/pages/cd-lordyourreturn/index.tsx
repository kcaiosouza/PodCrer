...
export default function cdlordyourreturn({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Lord Your Return | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdlordyourreturn', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
