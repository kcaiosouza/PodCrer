...
export default function cdenlomasalto({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD En Lo Más Alto | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdenlomasalto', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
