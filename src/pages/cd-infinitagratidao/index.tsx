...
export default function cdinfinitagratidao({ latestEpisodes, allEpisodes }: HomeProps) {
  ...
  return (
    <HomepageComponent>
      ...
      <Head>
        <title>CD Infinita Gratidão | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdinfinitagratidao', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
