...
export default function cdfalandocantando21a40({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Falando e Cantando Hinos - 21 a 40 | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdfalandocantando21a40', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
