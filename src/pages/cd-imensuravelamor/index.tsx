...
export default function cdimensuravelamor({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Imensurável Amor | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdimensuravelamor', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
