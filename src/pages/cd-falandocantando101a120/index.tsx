...
export default function cdfalandocantando101a120({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Falando e Cantando Hinos 101 a 120 | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdfalandocantando101a120', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
