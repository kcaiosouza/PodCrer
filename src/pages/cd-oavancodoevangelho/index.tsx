...
export default function cdoavancodoevangelho({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD O Avanço do Evangelho | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdoavancodoevangelho', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
