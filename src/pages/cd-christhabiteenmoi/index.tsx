...
export default function cdchristhabiteenmoi({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title> CD Christ Habite en Moi | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdchristhabiteenmoi', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
