...
export default function cdriosdeaguaviva({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Rios de Água Viva | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdriosdeaguaviva', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
