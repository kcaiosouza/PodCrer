...
export default function cdcautivoentubelleza({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Cautivo en Tu belleza | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdcautivoentubelleza', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
