...
export default function cdesteeoanodojubileu({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Este é o Ano do Jubileu! | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdesteeoanodojubileu', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
