...
export default function ahfol({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD A Heart Full of Love | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdaheartfulloflove', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
