...
export default function cdfalandocantando41a60({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Falando e Cantando Hinos 41 a 60 | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdfalandocantando41a60', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
