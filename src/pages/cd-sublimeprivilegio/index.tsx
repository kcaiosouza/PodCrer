...
export default function cdsublimeprivilegio({ latestEpisodes, allEpisodes }: HomeProps) {
  ...
  return (
    <HomepageComponent>
      ...
      <Head>
        <title>CD Sublime Privilégio | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdsublimeprivilegio', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
