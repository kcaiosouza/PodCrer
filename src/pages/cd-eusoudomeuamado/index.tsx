...
export default function eusoudomeuamado({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Eu Sou do Meu Amado | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdeusoudomeuamado', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
