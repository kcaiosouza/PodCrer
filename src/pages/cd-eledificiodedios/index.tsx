...
export default function cdeledificiodedios({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD El Edificio de Dios | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdeledificiodedios', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
