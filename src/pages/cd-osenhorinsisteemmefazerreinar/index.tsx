...
export default function cdosenhorinsisteemmefazerreinar({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD O Senhor Insiste em me Fazer Reinar | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdosenhorinsisteemmefazerreinar', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
