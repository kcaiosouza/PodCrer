...
export default function cdthisdivineromance({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD This Divine Romance | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdthisdivineromance', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
