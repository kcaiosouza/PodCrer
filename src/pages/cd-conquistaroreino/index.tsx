...
export default function cdconquistaroreino({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Conquistar o Reino | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdconquistaroreino', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
