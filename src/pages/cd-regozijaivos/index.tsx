...
export default function cdregozijaivos({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Regozijai-vos | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdregozijaivos', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
