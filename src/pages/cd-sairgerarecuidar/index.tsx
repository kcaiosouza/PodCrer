...
export default function sairgerarecuidar({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Sair, Gerar e Cuidar | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdsairgerarecuidar', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
