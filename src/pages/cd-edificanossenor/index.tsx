...
export default function cdedificanossenor({ latestEpisodes, allEpisodes }: HomeProps) {
  const emojiChoose = [
    '🎵',
    '🎶',
    '📻',
  ...
  return (
    <HomepageComponent>
      <ToastContainer />
      <Head>
        <title>CD Edifícanos Señor | IGCGMusic</title>
      </Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const { data } = await api.get('cdedificanossenor', {
    params: {
      _limit: 1000,
      _sort: 'published_at',
      _order: 'desc',
